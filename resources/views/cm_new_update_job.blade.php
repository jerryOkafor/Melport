...
@section('content')
  ...
  @include('shared.cm_side_bar')
    <div class="col-sm-9" id="col_center_right">
	 ...
	 <a href="{{url('/cm')}}"class="pull-right" title="Go Back" >
	   ...
	   <div class="row">
        ...
        <div class="panel-heading">
          <div class="panel-title">
            ...
            <h4>Create &AMP; Update Jobs On the Go!</h4>
          </div>
        </div>
        <div class="panel-body">          
          <form class="form form-vertical" method="POST" action="{{url('/cm/job/new/update/submit')}}">
	    {!!csrf_field()!!}
            <div class="control-group">
              <label>Job Id</label>
              <div class="controls">
                <input type="text" name="job_id" class="form-control" placeholder="081215">
              </div>
            </div>      
            <div class="control-group">
	    ...
	    <div class="control-group">
              ...
              <div class="controls">
                <input type="date" name="date_started" class="form-control" placeholder="12/11/2015">
              </div>
            </div> 
	    <div class="control-group">
              <label>Time Started</label>
              <div class="controls">
                <input type="time" name="time_started" class="form-control" placeholder="12:30">
              </div>
            </div> 
	    <div class="controls">
